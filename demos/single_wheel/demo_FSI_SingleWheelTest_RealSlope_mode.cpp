...
std::string out_dir = GetChronoOutputPath() + "FSI_Single_Wheel_Test_RealSlope_mode_slope";
...
int main(int argc, char* argv[]) {
    ...
    std::string inputJson = GetChronoDataFile("fsi/input_json/demo_FSI_SingleWheelTest_RealSlope_mode.json");
    if (argc == 3) {
